...
func (m *MockAnalyzerAgent) Execute(ctx context.Context, req schema.AgentRequest) (schema.AgentResponse, error) {
	...
	output := &schema.AgentOutputV1{
		...
		Patterns: []schema.Pattern{
			{
				Name:        "Pure Function: Add",
				File:        filePath,
				Lines:       "6-8",
				Description: "Mathematical function with no side effects",
			},
			{
				Name:        "Pure Function: Multiply",
				File:        filePath,
				Lines:       "16-19",
		...
		RawEvidence: []schema.Evidence{
			...
			// Granular evidence for specific line references
			{
				Claim: "Add function signature and parameters",
				File:  filePath,
				Lines: "6",
			},
			{
				Claim: "Add function return statement with addition operation",
				File:  filePath,
				Lines: "7",
			},
			{
				Claim: "Greet function signature and parameter",
				File:  filePath,
				Lines: "11",
			},
			{
				Claim: "Printf call in Greet function",
				File:  filePath,
				Lines: "12",
			},
			{
				Claim: "Multiply function signature and parameters",
				File:  filePath,
				Lines: "16",
			},
			{
				Claim: "Multiplication operation in Multiply function",
				File:  filePath,
				Lines: "17",
			},
			{
				Claim: "Multiply function return statement",
				File:  filePath,
				Lines: "18",
			},
			{
				Claim: "Pure Function: Add",
				File:  filePath,
				Lines: "6-8",
			},
			{
				Claim: "Pure Function: Multiply",
				File:  filePath,
				Lines: "16-19",
			},
		},
